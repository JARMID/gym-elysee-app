...
class WebChallengesPage extends StatelessWidget {
  const WebChallengesPage({super.key});
                    ...
                    children: [
                      ...
                      ...leaderboard.asMap().entries.map((entry) {
                        ...
                        return FadeInUp(
                          ...
                          child: _buildLeaderboardRow(item, isDark),
                        );
                      }),
                    ],
                  ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 32),
                      _buildRule("1", l10n.rule1Title, l10n.rule1Desc, isDark),
                      _buildRule("2", l10n.rule2Title, l10n.rule2Desc, isDark),
                      _buildRule("3", l10n.rule3Title, l10n.rule3Desc, isDark),
                      _buildRule("4", l10n.rule4Title, l10n.rule4Desc, isDark),
                    ],
                  ),
                ),
  ...
  Widget _buildLeaderboardRow(_LeaderboardEntry entry, bool isDark) {
